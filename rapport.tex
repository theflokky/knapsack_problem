...
\section{Tests}
    ...
    \subsection{Test Results on 0/1 Problems}
        ...
        \captionof{figure}{Table representing the Solution found by each algorithm.}
    ...
    \captionof{figure}{Comparison between GRASP, Brute Force and all Greedy}
    ...
    \captionof{figure}{Table representing the Solution found for each algorithm.}
